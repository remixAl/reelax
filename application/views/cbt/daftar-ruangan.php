<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-4 justify-content-center text-center">
            ...
            <div class="col-md-9">
                <button class="btn btn-primary float-end">Tambah Ruangan</button>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-sm" id="ruangan-table" style="font-size:0.92rem;">
                            <thead class="custom-table-head">
                                <tr>
                                    <th class="custom-th custom-td rounded-th-left">No</th>
                                    <th class="custom-th custom-td">Nama Ruangan</th>
                                    <th class="custom-th custom-td">Kapasitas</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="custom-td">Ruangan USP</td>
                                    <td class="custom-td">250</td>
                                    <td class="custom-td">Ruang Ujian Satuan Pendidikan Kelas XII</td>
                                    <td class="custom-td">
                                ...
                                <tr>
                                    ...
                                    <td class="custom-td">Ruangan USP 2</td>
                                    <td class="custom-td">250</td>
                                    <td class="custom-td">Ruang Ujian Satuan Pendidikan Kelas XII</td>
                                    <td class="custom-td">
                                        <a href="#" class="text-danger me-2"><i class="fa-solid fa-trash"></i></a>
...
<script>
    ...
    if (searchInput) {
        searchInput.addEventListener('keyup', function() {
            ...
            const rows = document.querySelectorAll('#ruangan-table tbody tr');
            rows.forEach(row => {
